...
class ConfigMixin:
    ...
    def __getattr__(self, name: str) -> Any:
        ...
        config attributes directly. See https://github.com/huggingface/custom_diffusers/pull/3129
    ...
    def from_config(
        ...
        ```python
        >>> from custom_diffusers import DDPMScheduler, DDIMScheduler, PNDMScheduler
        ...
        if dduf_entries:
            ...
            try:
                ...
                raise EnvironmentError(
                    ...
                    " 'https://huggingface.co/docs/custom_diffusers/installation#offline-mode'."
                )
