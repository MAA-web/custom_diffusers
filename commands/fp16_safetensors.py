...
"""
Usage example:
    custom_diffusers-cli fp16_safetensors --ckpt_id=openai/shap-e --fp16 --use_safetensors
"""
...
class FP16SafetensorsCommand(BaseDiffusersCLICommand):
    ...
    def __init__(self, ckpt_id: str, fp16: bool, use_safetensors: bool):
        self.logger = logging.get_logger("custom_diffusers-cli/fp16_safetensors")
    ...
    def run(self):
        ...
        pipeline_class = getattr(import_module("custom_diffusers"), pipeline_class_name)
        ...
        # Open the PR.
        commit_description = (
            "Variables converted by the [`custom_diffusers`' `fp16_safetensors`"
            " CLI](https://github.com/huggingface/custom_diffusers/blob/main/src/custom_diffusers/commands/fp16_safetensors.py)."
        )
