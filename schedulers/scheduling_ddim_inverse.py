...
from custom_diffusers.configuration_utils import ConfigMixin, register_to_config
from custom_diffusers.schedulers.scheduling_utils import SchedulerMixin
from custom_diffusers.utils import BaseOutput, deprecate


@dataclass
# Copied from custom_diffusers.schedulers.scheduling_ddpm.DDPMSchedulerOutput with DDPM->DDIM
