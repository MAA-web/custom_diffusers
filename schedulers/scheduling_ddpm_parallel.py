...
@dataclass
# Copied from custom_diffusers.schedulers.scheduling_ddpm.DDPMSchedulerOutput
...
class DDPMParallelScheduler(SchedulerMixin, ConfigMixin):
    ...
    @register_to_config
    # Copied from custom_diffusers.schedulers.scheduling_ddpm.DDPMScheduler.__init__
    def __init__(
        self,
    ...
    # Copied from custom_diffusers.schedulers.scheduling_ddpm.DDPMScheduler.scale_model_input
    ...
    # Copied from custom_diffusers.schedulers.scheduling_ddpm.DDPMScheduler.set_timesteps
    def set_timesteps(
        self,
    ...
    # Copied from custom_diffusers.schedulers.scheduling_ddpm.DDPMScheduler._get_variance
