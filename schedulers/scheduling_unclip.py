...
@dataclass
# Copied from custom_diffusers.schedulers.scheduling_ddpm.DDPMSchedulerOutput with DDPM->UnCLIP
...
class UnCLIPScheduler(SchedulerMixin, ConfigMixin):
    ...
    def set_timesteps(self, num_inference_steps: int, device: Union[str, torch.device] = None):
        ...
        Note that this scheduler uses a slightly different step ratio than the other custom_diffusers schedulers. The
