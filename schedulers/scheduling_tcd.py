...
class TCDScheduler(SchedulerMixin, ConfigMixin):
    ...
    # Copied from custom_diffusers.schedulers.scheduling_ddim.DDIMScheduler._get_variance
    ...
    def set_timesteps(
        ...
        Args:
            ...
            original_inference_steps (`int`, *optional*):
                ...
                schedule (which is different from the standard `custom_diffusers` implementation). We will then take
    ...
    # Copied from custom_diffusers.schedulers.scheduling_ddpm.DDPMScheduler.get_velocity
    ...
    # Copied from custom_diffusers.schedulers.scheduling_ddpm.DDPMScheduler.previous_timestep
