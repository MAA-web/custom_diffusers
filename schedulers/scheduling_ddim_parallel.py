...
class DDIMParallelScheduler(SchedulerMixin, ConfigMixin):
    ...
    @register_to_config
    # Copied from custom_diffusers.schedulers.scheduling_ddim.DDIMScheduler.__init__
    def __init__(
        self,
    ...
    # Copied from custom_diffusers.schedulers.scheduling_ddim.DDIMScheduler.scale_model_input
    ...
    # Copied from custom_diffusers.schedulers.scheduling_ddim.DDIMScheduler.set_timesteps
