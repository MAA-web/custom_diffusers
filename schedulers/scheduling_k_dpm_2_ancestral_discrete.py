...
@dataclass
# Copied from custom_diffusers.schedulers.scheduling_ddpm.DDPMSchedulerOutput with DDPM->KDPM2AncestralDiscrete
...
class KDPM2AncestralDiscreteScheduler(SchedulerMixin, ConfigMixin):
    ...
    # Copied from custom_diffusers.schedulers.scheduling_euler_discrete.EulerDiscreteScheduler.index_for_timestep
    ...
    # Copied from custom_diffusers.schedulers.scheduling_euler_discrete.EulerDiscreteScheduler._init_step_index
