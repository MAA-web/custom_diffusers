...
class ControlNetXSAdapter(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        # see https://github.com/huggingface/custom_diffusers/issues/2011#issuecomment-1547958131 for why `ControlNetXSAdapter` takes `num_attention_heads` instead of `attention_head_dim`
    ...
    def from_unet(
        ...
        Parameters:
            ...
            num_attention_heads (`List[int]`, *optional*, defaults to `None`):
                ...
                https://github.com/huggingface/custom_diffusers/issues/2011#issuecomment-1547958131 for why.
            learn_time_embedding (`bool`, defaults to `False`):
        ...
        if num_attention_heads is None:
            # The naming seems a bit confusing and it is, see https://github.com/huggingface/custom_diffusers/issues/2011#issuecomment-1547958131 for why.
