...
class MultiControlNetUnionModel(ModelMixin):
    ...
    # Copied from custom_diffusers.models.controlnets.multicontrolnet.MultiControlNetModel.save_pretrained with ControlNet->ControlNetUnion
    def save_pretrained(
        self,
    ...
    @classmethod
    # Copied from custom_diffusers.models.controlnets.multicontrolnet.MultiControlNetModel.from_pretrained with ControlNet->ControlNetUnion
