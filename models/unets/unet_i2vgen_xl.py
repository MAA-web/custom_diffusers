...
class I2VGenXLUNet(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    # Copied from custom_diffusers.models.unets.unet_3d_condition.UNet3DConditionModel.enable_forward_chunking
    ...
    # Copied from custom_diffusers.models.unets.unet_3d_condition.UNet3DConditionModel.disable_forward_chunking
