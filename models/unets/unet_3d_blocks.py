...
class DownBlockMotion(DownBlockMotion):
    def __init__(self, *args, **kwargs):
        deprecation_message = "Importing `DownBlockMotion` from `custom_diffusers.models.unets.unet_3d_blocks` is deprecated and this will be removed in a future version. Please use `from custom_diffusers.models.unets.unet_motion_model import DownBlockMotion` instead."
...
class CrossAttnDownBlockMotion(CrossAttnDownBlockMotion):
    def __init__(self, *args, **kwargs):
        deprecation_message = "Importing `CrossAttnDownBlockMotion` from `custom_diffusers.models.unets.unet_3d_blocks` is deprecated and this will be removed in a future version. Please use `from custom_diffusers.models.unets.unet_motion_model import CrossAttnDownBlockMotion` instead."
...
class UpBlockMotion(UpBlockMotion):
    def __init__(self, *args, **kwargs):
        deprecation_message = "Importing `UpBlockMotion` from `custom_diffusers.models.unets.unet_3d_blocks` is deprecated and this will be removed in a future version. Please use `from custom_diffusers.models.unets.unet_motion_model import UpBlockMotion` instead."
...
class CrossAttnUpBlockMotion(CrossAttnUpBlockMotion):
    def __init__(self, *args, **kwargs):
        deprecation_message = "Importing `CrossAttnUpBlockMotion` from `custom_diffusers.models.unets.unet_3d_blocks` is deprecated and this will be removed in a future version. Please use `from custom_diffusers.models.unets.unet_motion_model import CrossAttnUpBlockMotion` instead."
...
class UNetMidBlockCrossAttnMotion(UNetMidBlockCrossAttnMotion):
    def __init__(self, *args, **kwargs):
        deprecation_message = "Importing `UNetMidBlockCrossAttnMotion` from `custom_diffusers.models.unets.unet_3d_blocks` is deprecated and this will be removed in a future version. Please use `from custom_diffusers.models.unets.unet_motion_model import UNetMidBlockCrossAttnMotion` instead."
