...
class ModelMixin(torch.nn.Module, PushToHubMixin):
    ...
    def __getattr__(self, name: str) -> Any:
        ...
        config attributes directly. See https://github.com/huggingface/custom_diffusers/pull/3129 We need to overwrite
    ...
    def enable_layerwise_casting(
        ...
        By default, most models in custom_diffusers set the `_skip_layerwise_casting_patterns` attribute to ignore patch
        ...
        Example:
            ...
            ```python
            >>> from custom_diffusers import CogVideoXTransformer3DModel
        ...
        if is_peft_available() and not user_provided_patterns:
            ...
            # `~custom_diffusers.hooks.layerwise_casting.apply_layerwise_casting` function which provides
    ...
    def enable_group_offload(
        ...
        if not self._supports_group_offloading:
            raise ValueError(
                ...
                f"open an issue at https://github.com/huggingface/custom_diffusers/issues."
            )
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs) -> Self:
        ...
        Parameters:
            ...
            device_map (`Union[int, str, torch.device]` or `Dict[str, Union[int, str, torch.device]]`, *optional*):
                ...
                ```py
                >>> from custom_diffusers import AutoModel
                >>> import torch
                ...
                documentation](https://huggingface.co/docs/custom_diffusers/main/en/training/distributed_inference#model-sharding)
        ...
        ["offline-mode"](https://huggingface.co/custom_diffusers/installation.html#offline-mode) to use this method in a
