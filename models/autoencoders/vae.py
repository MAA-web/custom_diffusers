...
class Encoder(nn.Module):
    ...
    Args:
        ...
        down_block_types (`Tuple[str, ...]`, *optional*, defaults to `("DownEncoderBlock2D",)`):
            The types of down blocks to use. See `~custom_diffusers.models.unet_2d_blocks.get_down_block` for available
            options.
        ...
        act_fn (`str`, *optional*, defaults to `"silu"`):
            The activation function to use. See `~custom_diffusers.models.activations.get_activation` for available options.
...
class Decoder(nn.Module):
    ...
    Args:
        ...
        up_block_types (`Tuple[str, ...]`, *optional*, defaults to `("UpDecoderBlock2D",)`):
            The types of up blocks to use. See `~custom_diffusers.models.unet_2d_blocks.get_up_block` for available options.
        block_out_channels (`Tuple[int, ...]`, *optional*, defaults to `(64,)`):
            The number of output channels for each block.
        layers_per_block (`int`, *optional*, defaults to 2):
            The number of layers per block.
...
class DecoderTiny(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # scale image from [0, 1] to [-1, 1] to match custom_diffusers convention
