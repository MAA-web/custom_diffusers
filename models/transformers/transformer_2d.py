...
class Transformer2DModelOutput(Transformer2DModelOutput):
    def __init__(self, *args, **kwargs):
        deprecation_message = "Importing `Transformer2DModelOutput` from `custom_diffusers.models.transformer_2d` is deprecated and this will be removed in a future version. Please use `from custom_diffusers.models.modeling_outputs import Transformer2DModelOutput`, instead."
