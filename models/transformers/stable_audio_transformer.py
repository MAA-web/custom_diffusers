...
class StableAudioGaussianFourierProjection(nn.Module):
    ...
    # Copied from custom_diffusers.models.embeddings.GaussianFourierProjection.__init__
    def __init__(
...
class StableAudioDiTModel(ModelMixin, ConfigMixin):
    ...
    # Copied from custom_diffusers.models.transformers.hunyuan_transformer_2d.HunyuanDiT2DModel.set_default_attn_processor with Hunyuan->StableAudio
