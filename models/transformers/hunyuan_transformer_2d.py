...
class HunyuanDiTBlock(nn.Module):
    ...
    # Copied from custom_diffusers.models.attention.BasicTransformerBlock.set_chunk_feed_forward
...
class HunyuanDiT2DModel(ModelMixin, ConfigMixin):
    ...
    # Copied from custom_diffusers.models.unets.unet_2d_condition.UNet2DConditionModel.fuse_qkv_projections with FusedAttnProcessor2_0->FusedHunyuanAttnProcessor2_0
