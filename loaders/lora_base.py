...
def _load_lora_into_text_encoder(
    ...
    if prefix is not None and not state_dict:
        ...
        logger.warning(
            ...
            "https://github.com/huggingface/custom_diffusers/issues/new"
        )
...
class LoraBaseMixin:
    ...
    def fuse_lora(
        ...
        **kwargs,
        ...
        for fuse_component in components:
            ...
            if model is not None:
                # check if custom_diffusers model
                if issubclass(model.__class__, ModelMixin):
    ...
    def _fetch_state_dict(cls, *args, **kwargs):
        deprecation_message = f"Using the `_fetch_state_dict()` method from {cls} has been deprecated and will be removed in a future version. Please use `from custom_diffusers.loaders.lora_base import _fetch_state_dict`."
    ...
    def _best_guess_weight_name(cls, *args, **kwargs):
        deprecation_message = f"Using the `_best_guess_weight_name()` method from {cls} has been deprecated and will be removed in a future version. Please use `from custom_diffusers.loaders.lora_base import _best_guess_weight_name`."
