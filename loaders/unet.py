...
class UNet2DConditionLoadersMixin:
    ...
    def load_attn_procs(self, pretrained_model_name_or_path_or_dict: Union[str, Dict[str, torch.Tensor]], **kwargs):
        ...
        defined in
        [`attention_processor.py`](https://github.com/huggingface/custom_diffusers/blob/main/src/custom_diffusers/models/attention_processor.py)
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_base.LoraBaseMixin._optionally_disable_offloading
    ...
    def _load_ip_adapter_weights(self, state_dicts, low_cpu_mem_usage=_LOW_CPU_MEM_USAGE_DEFAULT):
        ...
        # convert IP-Adapter Image Projection layers to custom_diffusers
