...
class StableDiffusionLoraLoaderMixin(LoraBaseMixin):
        ...
        **kwargs,
        ...
        Parameters:
            ...
            hotswap (`bool`, *optional*):
                ...
                ```py
                pipeline = ...  # load custom_diffusers pipeline
    ...
    def lora_state_dict(
        ...
        **kwargs,
        ...
        if is_dora_scale_present:
            warn_msg = "It seems like you are using a DoRA checkpoint that is not compatible in Diffusers at the moment. So, we are going to filter out the keys associated to 'dora_scale` from the state dict. If you think this is a mistake please open an issue https://github.com/huggingface/custom_diffusers/issues/new."
    ...
    def load_lora_into_unet(
        ...
        # If the serialization format is new (introduced in https://github.com/huggingface/custom_diffusers/pull/2918),
    ...
    def fuse_lora(
        ...
        **kwargs,
        ...
        ```py
        from custom_diffusers import DiffusionPipeline
        import torch
    ...
    def unfuse_lora(self, components: List[str] = ["unet", "text_encoder"], **kwargs):
        ...
        [`pipe.fuse_lora()`](https://huggingface.co/docs/custom_diffusers/main/en/api/loaders#custom_diffusers.loaders.LoraBaseMixin.fuse_lora).
...
class StableDiffusionXLLoraLoaderMixin(LoraBaseMixin):
    ...
    @classmethod
    @validate_hf_hub_args
    # Copied from custom_diffusers.loaders.lora_pipeline.StableDiffusionLoraLoaderMixin.lora_state_dict
    def lora_state_dict(
        cls,
        pretrained_model_name_or_path_or_dict: Union[str, Dict[str, torch.Tensor]],
        **kwargs,
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.StableDiffusionLoraLoaderMixin.load_lora_into_unet
    def load_lora_into_unet(
        cls,
        state_dict,
        network_alphas,
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.StableDiffusionLoraLoaderMixin.load_lora_into_text_encoder
    def load_lora_into_text_encoder(
        cls,
        state_dict,
        network_alphas,
...
class SD3LoraLoaderMixin(LoraBaseMixin):
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.StableDiffusionXLLoraLoaderMixin.save_lora_weights with unet->transformer
    def save_lora_weights(
        cls,
        save_directory: Union[str, os.PathLike],
    ...
    # Copied from custom_diffusers.loaders.lora_pipeline.StableDiffusionXLLoraLoaderMixin.fuse_lora with unet->transformer
    def fuse_lora(
        self,
    ...
    # Copied from custom_diffusers.loaders.lora_pipeline.StableDiffusionXLLoraLoaderMixin.unfuse_lora with unet->transformer
...
class AuraFlowLoraLoaderMixin(LoraBaseMixin):
    ...
    @classmethod
    @validate_hf_hub_args
    # Copied from custom_diffusers.loaders.lora_pipeline.CogVideoXLoraLoaderMixin.lora_state_dict
    def lora_state_dict(
        cls,
        pretrained_model_name_or_path_or_dict: Union[str, Dict[str, torch.Tensor]],
        **kwargs,
    ...
    # Copied from custom_diffusers.loaders.lora_pipeline.CogVideoXLoraLoaderMixin.load_lora_weights
    def load_lora_weights(
        self,
        pretrained_model_name_or_path_or_dict: Union[str, Dict[str, torch.Tensor]],
        adapter_name: Optional[str] = None,
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.SD3LoraLoaderMixin.load_lora_into_transformer with SD3Transformer2DModel->AuraFlowTransformer2DModel
    def load_lora_into_transformer(
        cls,
        state_dict,
        transformer,
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.CogVideoXLoraLoaderMixin.save_lora_weights
    def save_lora_weights(
        cls,
        save_directory: Union[str, os.PathLike],
        transformer_lora_layers: Dict[str, Union[torch.nn.Module, torch.Tensor]] = None,
    ...
    # Copied from custom_diffusers.loaders.lora_pipeline.SanaLoraLoaderMixin.fuse_lora
    def fuse_lora(
        self,
    ...
    # Copied from custom_diffusers.loaders.lora_pipeline.SanaLoraLoaderMixin.unfuse_lora
...
class FluxLoraLoaderMixin(LoraBaseMixin):
    ...
    def _load_norm_into_transformer(
        ...
        logger.info(
            ...
            "If you notice something unexpected, please open an issue: https://github.com/huggingface/custom_diffusers/issues."
        )
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.StableDiffusionLoraLoaderMixin.save_lora_weights with unet->transformer
    def save_lora_weights(
        cls,
        save_directory: Union[str, os.PathLike],
        transformer_lora_layers: Dict[str, Union[torch.nn.Module, torch.Tensor]] = None,
    ...
    def unload_lora_weights(self, reset_to_overwritten_params=False):
        ...
        Args:
            reset_to_overwritten_params (`bool`, defaults to `False`): Whether to reset the LoRA-loaded modules
                ...
                documentation](https://huggingface.co/docs/custom_diffusers/main/en/api/pipelines/flux) to learn more.
        ...
        for k in lora_module_names:
            ...
            if base_module_shape[1] > lora_A_param.shape[1]:
                ...
                raise NotImplementedError(
                    f"This LoRA param ({k}.lora_A.weight) has an incompatible shape {lora_A_param.shape}. Please open an issue to file for a feature request - https://github.com/huggingface/custom_diffusers/issues/new."
                )

        if expanded_module_names:
            logger.info(
                f"The following LoRA modules were zero padded to match the state dict of {cls.transformer_name}: {expanded_module_names}. Please open an issue if you think this was unexpected - https://github.com/huggingface/custom_diffusers/issues/new."
            )
...
class AmusedLoraLoaderMixin(StableDiffusionLoraLoaderMixin):
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.FluxLoraLoaderMixin.load_lora_into_transformer with FluxTransformer2DModel->UVit2DModel
    def load_lora_into_transformer(
        cls,
        state_dict,
        network_alphas,
...
class CogVideoXLoraLoaderMixin(LoraBaseMixin):
    ...
    @classmethod
    @validate_hf_hub_args
    # Copied from custom_diffusers.loaders.lora_pipeline.SD3LoraLoaderMixin.lora_state_dict
    def lora_state_dict(
        cls,
        pretrained_model_name_or_path_or_dict: Union[str, Dict[str, torch.Tensor]],
        **kwargs,
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.SD3LoraLoaderMixin.load_lora_into_transformer with SD3Transformer2DModel->CogVideoXTransformer3DModel
    def load_lora_into_transformer(
        cls,
        state_dict,
        transformer,
    ...
    @classmethod
    # Adapted from custom_diffusers.loaders.lora_pipeline.StableDiffusionLoraLoaderMixin.save_lora_weights without support for text encoder
    def save_lora_weights(
        cls,
        save_directory: Union[str, os.PathLike],
        transformer_lora_layers: Dict[str, Union[torch.nn.Module, torch.Tensor]] = None,
...
class Mochi1LoraLoaderMixin(LoraBaseMixin):
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.SD3LoraLoaderMixin.load_lora_into_transformer with SD3Transformer2DModel->MochiTransformer3DModel
    def load_lora_into_transformer(
        cls,
        state_dict,
        transformer,
    ...
    # Copied from custom_diffusers.loaders.lora_pipeline.CogVideoXLoraLoaderMixin.fuse_lora
    def fuse_lora(
        self,
        components: List[str] = ["transformer"],
        lora_scale: float = 1.0,
    ...
    # Copied from custom_diffusers.loaders.lora_pipeline.CogVideoXLoraLoaderMixin.unfuse_lora
    def unfuse_lora(self, components: List[str] = ["transformer"], **kwargs):
        r"""
        Reverses the effect of
        [`pipe.fuse_lora()`](https://huggingface.co/docs/custom_diffusers/main/en/api/loaders#custom_diffusers.loaders.LoraBaseMixin.fuse_lora).
...
class LTXVideoLoraLoaderMixin(LoraBaseMixin):
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.SD3LoraLoaderMixin.load_lora_into_transformer with SD3Transformer2DModel->LTXVideoTransformer3DModel
    def load_lora_into_transformer(
        cls,
        state_dict,
        transformer,
...
class SanaLoraLoaderMixin(LoraBaseMixin):
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.SD3LoraLoaderMixin.load_lora_into_transformer with SD3Transformer2DModel->SanaTransformer2DModel
    def load_lora_into_transformer(
        cls,
        state_dict,
        transformer,
...
class HunyuanVideoLoraLoaderMixin(LoraBaseMixin):
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.SD3LoraLoaderMixin.load_lora_into_transformer with SD3Transformer2DModel->HunyuanVideoTransformer3DModel
    def load_lora_into_transformer(
        cls,
        state_dict,
        transformer,
...
class Lumina2LoraLoaderMixin(LoraBaseMixin):
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.SD3LoraLoaderMixin.load_lora_into_transformer with SD3Transformer2DModel->Lumina2Transformer2DModel
    def load_lora_into_transformer(
        cls,
        state_dict,
        transformer,
...
class WanLoraLoaderMixin(LoraBaseMixin):
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.SD3LoraLoaderMixin.load_lora_into_transformer with SD3Transformer2DModel->WanTransformer3DModel
    def load_lora_into_transformer(
        cls,
        state_dict,
        transformer,
...
class CogView4LoraLoaderMixin(LoraBaseMixin):
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.SD3LoraLoaderMixin.load_lora_into_transformer with SD3Transformer2DModel->CogView4Transformer2DModel
    def load_lora_into_transformer(
        cls,
        state_dict,
        transformer,
...
class HiDreamImageLoraLoaderMixin(LoraBaseMixin):
    ...
    @classmethod
    # Copied from custom_diffusers.loaders.lora_pipeline.SD3LoraLoaderMixin.load_lora_into_transformer with SD3Transformer2DModel->HiDreamImageTransformer2DModel
    def load_lora_into_transformer(
        cls,
        state_dict,
        transformer,
