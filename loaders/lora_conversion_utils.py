...
def _convert_non_diffusers_lora_to_diffusers(state_dict, unet_name="unet", text_encoder_name="text_encoder"):
    ...
    logger.info("Non-custom_diffusers checkpoint detected.")
...
def _convert_text_encoder_lora_key(key, lora_name):
    ...
    if "self_attn" in diffusers_name or "text_projection" in diffusers_name:
        ...
        # Be aware that this is the new custom_diffusers convention and the rest of the code might
        # not utilize it yet.
        ...
        if has_position_embedding:
            ...
            if zero_status_pe:
                ...
                logger.info(
                    ...
                    "Open an issue if you need this supported - https://github.com/huggingface/custom_diffusers/issues/new."
                )
        ...
        if has_t5xxl:
            ...
            if zero_status_t5:
                ...
                logger.info(
                    ...
                    "Open an issue if this is a problem - https://github.com/huggingface/custom_diffusers/issues/new."
                )
...
def _convert_hunyuan_video_lora_to_diffusers(original_state_dict):
    ...
    # Some folks attempt to make their state dict compatible with custom_diffusers by adding "transformer." prefix to all keys
    # and use their custom code. To make sure both "original" and "attempted custom_diffusers" loras work as expected, we make
