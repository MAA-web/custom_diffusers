...
DIFFUSERS_DEFAULT_PIPELINE_PATHS = {
    ...
    "xl_inpaint": {"pretrained_model_name_or_path": "custom_diffusers/stable-diffusion-xl-1.0-inpainting-0.1"},
    ...
    "controlnet_xl_large": {"pretrained_model_name_or_path": "custom_diffusers/controlnet-canny-sdxl-1.0"},
    "controlnet_xl_mid": {"pretrained_model_name_or_path": "custom_diffusers/controlnet-canny-sdxl-1.0-mid"},
    "controlnet_xl_small": {"pretrained_model_name_or_path": "custom_diffusers/controlnet-canny-sdxl-1.0-small"},
    ...
    "sd3": {
        "pretrained_model_name_or_path": "stabilityai/stable-diffusion-3-medium-custom_diffusers",
    },
    "sd35_large": {
    ...
    "ltx-video": {"pretrained_model_name_or_path": "custom_diffusers/LTX-Video-0.9.0"},
    "ltx-video-0.9.1": {"pretrained_model_name_or_path": "custom_diffusers/LTX-Video-0.9.1"},
    ...
    "autoencoder-dc-f128c512": {"pretrained_model_name_or_path": "mit-han-lab/dc-ae-f128c512-mix-1.0-custom_diffusers"},
    "autoencoder-dc-f64c128": {"pretrained_model_name_or_path": "mit-han-lab/dc-ae-f64c128-mix-1.0-custom_diffusers"},
    "autoencoder-dc-f32c32": {"pretrained_model_name_or_path": "mit-han-lab/dc-ae-f32c32-mix-1.0-custom_diffusers"},
    "autoencoder-dc-f32c32-sana": {"pretrained_model_name_or_path": "mit-han-lab/dc-ae-f32c32-sana-1.0-custom_diffusers"},
...
# Copied from custom_diffusers.pipelines.stable_diffusion.convert_from_ckpt.conv_attn_to_linear
...
def create_unet_diffusers_config_from_ldm(
    ...
    """
    Creates a config for the custom_diffusers based on the config of the LDM model.
    """
...
def convert_ldm_vae_checkpoint(checkpoint, config):
    ...
    # remove the LDM_VAE_KEY prefix from the ldm checkpoint keys so that it is easier to map them to custom_diffusers keys
    vae_state_dict = {}
    keys = list(checkpoint.keys())
    vae_key = ""
    ...
    **kwargs,
    ...
    if scheduler_type is not None:
        deprecation_message = (
            ...
            "Example:\n\n"
            "from custom_diffusers import StableDiffusionPipeline, DDIMScheduler\n\n"
...
# while in custom_diffusers it split into scale, shift. Here we swap the linear projection weights in order to be able to use custom_diffusers implementation
