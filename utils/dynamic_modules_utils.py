...
# See https://huggingface.co/datasets/custom_diffusers/community-pipelines-mirror
COMMUNITY_PIPELINES_MIRROR_ID = "custom_diffusers/community-pipelines-mirror"


def get_diffusers_versions():
    url = "https://pypi.org/pypi/custom_diffusers/json"
...
def find_pipeline_class(loaded_module):
    ...
    for cls_name, cls in cls_members.items():
        if (
            ...
            and cls.__module__.split(".")[0] != "custom_diffusers"
        ):
    ...
    if os.path.isfile(module_file_or_url):
        ...
        try:
            ...
            raise EnvironmentError(
                ...
                " https://huggingface.co/datasets/custom_diffusers/community-pipelines-mirror/tree/main."
                " If you don't find the revision you are looking for, please open an issue on https://github.com/huggingface/custom_diffusers/issues."
            ) from e
