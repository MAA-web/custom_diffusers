...
def get_logger(name: Optional[str] = None) -> logging.Logger:
    ...
    This function is not supposed to be directly accessed unless you are writing a custom custom_diffusers module.
    """
...
def get_verbosity() -> int:
    ...
    Returns:
        `int`:
            ...
            - `50`: `custom_diffusers.logging.CRITICAL` or `custom_diffusers.logging.FATAL`
            - `40`: `custom_diffusers.logging.ERROR`
            - `30`: `custom_diffusers.logging.WARNING` or `custom_diffusers.logging.WARN`
            - `20`: `custom_diffusers.logging.INFO`
            - `10`: `custom_diffusers.logging.DEBUG`
...
def set_verbosity(verbosity: int) -> None:
    ...
    Args:
        verbosity (`int`):
            ...
            - `custom_diffusers.logging.CRITICAL` or `custom_diffusers.logging.FATAL`
            - `custom_diffusers.logging.ERROR`
            - `custom_diffusers.logging.WARNING` or `custom_diffusers.logging.WARN`
            - `custom_diffusers.logging.INFO`
            - `custom_diffusers.logging.DEBUG`
    """
...
def enable_explicit_format() -> None:
    ...
    for handler in handlers:
        formatter = logging.Formatter("Custom Diffusers - [%(levelname)s|%(filename)s:%(lineno)s] %(asctime)s >> %(message)s")
