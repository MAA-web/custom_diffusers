...
from custom_diffusers.utils.import_utils import is_optimum_quanto_version
...
class QuantoQuantizer(DiffusersQuantizer):
    ...
    def check_if_quantized_param(
        ...
        **kwargs,
        ...
        # Quanto imports custom_diffusers internally. This is here to prevent circular imports
