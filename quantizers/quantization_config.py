...
class TorchAoConfig(QuantizationConfigMixin):
    ...
    Example:
        ```python
        from custom_diffusers import FluxTransformer2DModel, TorchAoConfig
    ...
    def __init__(self, quant_type: str, modules_to_not_convert: Optional[List[str]] = None, **kwargs) -> None:
        ...
        if self.quant_type not in TORCHAO_QUANT_TYPE_METHODS.keys():
            ...
            raise ValueError(
                ...
                f"provided quantization type should be supported, please open an issue at https://github.com/huggingface/custom_diffusers/issues."
            )
