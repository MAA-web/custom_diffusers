...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from custom_diffusers import SanaSprintImg2ImgPipeline
        >>> from custom_diffusers.utils.loading_utils import load_image
        ...
        >>> image = load_image(
        ...     "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/custom_diffusers/penguin.png"
        ... )
...
class SanaSprintImg2ImgPipeline(DiffusionPipeline, SanaLoraLoaderMixin):
    ...
    # Copied from custom_diffusers.pipelines.sana.pipeline_sana.SanaPipeline.enable_vae_slicing
    ...
    # Copied from custom_diffusers.pipelines.sana.pipeline_sana.SanaPipeline.disable_vae_slicing
    ...
    # Copied from custom_diffusers.pipelines.sana.pipeline_sana.SanaPipeline.enable_vae_tiling
    ...
    # Copied from custom_diffusers.pipelines.sana.pipeline_sana.SanaPipeline._get_gemma_prompt_embeds
    ...
    # Copied from custom_diffusers.pipelines.sana.pipeline_sana_sprint.SanaSprintPipeline.encode_prompt
    def encode_prompt(
        self,
        prompt: Union[str, List[str]],
    ...
    def prepare_latents(
        ...
        # adapt from https://github.com/huggingface/custom_diffusers/blob/c36f8487df35895421c15f351c7d360bd680[…]/examples/research_projects/sana/train_sana_sprint_diffusers.py
