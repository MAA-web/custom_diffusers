...
class AutoPipelineForText2Image(ConfigMixin):
    ...
    def from_pipe(cls, pipeline, **kwargs):
        ...
        ```py
        >>> from custom_diffusers import AutoPipelineForText2Image, AutoPipelineForImage2Image
...
class AutoPipelineForInpainting(ConfigMixin):
    ...
    def from_pipe(cls, pipeline, **kwargs):
        ...
        ```py
        >>> from custom_diffusers import AutoPipelineForText2Image, AutoPipelineForInpainting
