...
from custom_diffusers.pipelines.stable_diffusion import StableDiffusionPipelineOutput
...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        from custom_diffusers import HunyuanDiT2DControlNetModel, HunyuanDiTControlNetPipeline
        import torch
...
class HunyuanDiTControlNetPipeline(DiffusionPipeline):
    ...
    # Copied from custom_diffusers.pipelines.hunyuandit.pipeline_hunyuandit.HunyuanDiTPipeline.encode_prompt
    def encode_prompt(
        self,
        prompt: str,
    ...
    # Copied from custom_diffusers.pipelines.hunyuandit.pipeline_hunyuandit.HunyuanDiTPipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        height,
