...
class DiffusionPipeline(ConfigMixin, PushToHubMixin):
        ...
        **kwargs,
        ...
        Arguments:
            ...
            max_shard_size (`int` or `str`, defaults to `None`):
                ...
                period of time (starting from Oct 2024) to allow users to upgrade to the latest version of `custom_diffusers`.
    ...
    def to(self, *args, **kwargs) -> Self:
        ...
        for module in modules:
            ...
            # components can be from outside custom_diffusers too, but still have group offloading enabled.
            if (
    ...
    def from_pretrained(cls, pretrained_model_name_or_path: Optional[Union[str, os.PathLike]], **kwargs) -> Self:
        ...
        Parameters:
            ...
            custom_pipeline (`str`, *optional*):
                ...
                Can be either:
                    ...
                    - A string, the *repo id* (for example `hf-internal-testing/custom_diffusers-dummy-pipeline`) of a custom
                      pipeline hosted on the Hub. The repository must contain a file called pipeline.py that defines
                      the custom pipeline.
                    - A string, the *file name* of a community pipeline hosted on GitHub under
                      [Community](https://github.com/huggingface/custom_diffusers/tree/main/examples/community). Valid file
                ...
                Adding Custom
                Pipelines](https://huggingface.co/docs/custom_diffusers/using-custom_diffusers/custom_pipeline_overview)
            ...
            device_map (`str`, *optional*):
                ...
                [this](https://huggingface.co/docs/custom_diffusers/main/en/tutorials/inference_with_big_models#device-placement)
                to know more.
        ...
        >>> from custom_diffusers import LMSDiscreteScheduler
        ...
        if not os.path.isdir(pretrained_model_name_or_path):
            ...
            print(f"Loading pipeline from local folder: {pretrained_model_name_or_path}")
        ...
        print("Custom Diffusers - {__file__} - config_dict:", config_dict)
        ...
        # when a user requests for a `StableDiffusionInpaintPipeline` with `custom_diffusers` version being <= 0.5.1.
        _maybe_raise_warning_for_inpainting(
        ...
        print(f"Custom Diffusers - {__file__} - expected_modules:", expected_modules)

        expected_types = pipeline_class._get_signature_types()

        print(f"Custom Diffusers - {__file__} - expected_types:", expected_types)

        passed_class_obj = {k: kwargs.pop(k) for k in expected_modules if k in kwargs}

        print(f"Custom Diffusers - {__file__} - passed_class_obj:", passed_class_obj)

        passed_pipe_kwargs = {k: kwargs.pop(k) for k in optional_kwargs if k in kwargs}
        
        print(f"Custom Diffusers - {__file__} - passed_pipe_kwargs:", passed_pipe_kwargs)

        init_dict, unused_kwargs, _ = pipeline_class.extract_init_dict(config_dict, **kwargs)
        
        print(f"Custom Diffusers - {__file__} - unused_kwargs:", unused_kwargs)

        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        print(f"Custom Diffusers - {__file__} - init_dict:", init_dict)
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        ...
        print(f"Custom Diffusers - {__file__} - init_kwargs:", init_kwargs)
        ...
        from custom_diffusers import pipelines
        ...
        if device_map is not None:
            ...
            print(f"Custom Diffusers - {__file__} - final_device_map:", final_device_map)
        ...
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
        print(f"Custom Diffusers - {__file__} - model: {model}")
        print("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@")
    ...
    def maybe_free_model_hooks(self):
        ...
        - Resets stateful custom_diffusers hooks of denoiser components if they were added with
    ...
    def download(cls, pretrained_model_name, **kwargs) -> Union[str, os.PathLike]:
        ...
        Parameters:
            ...
            custom_pipeline (`str`, *optional*):
                ...
                community pipeline](https://huggingface.co/docs/custom_diffusers/main/en/using-custom_diffusers/contribute_pipeline).
    ...
    def from_pipe(cls, pipeline, **kwargs):
        ...
        ```py
        >>> from custom_diffusers import StableDiffusionPipeline, StableDiffusionSAGPipeline
