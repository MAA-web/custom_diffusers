...
class UniDiffuserPipeline(DeprecatedPipelineMixin, DiffusionPipeline):
    ...
    # Copied from custom_diffusers.pipelines.pipeline_utils.StableDiffusionMixin.enable_vae_slicing
    ...
    # Copied from custom_diffusers.pipelines.pipeline_utils.StableDiffusionMixin.disable_vae_slicing
    ...
    # Copied from custom_diffusers.pipelines.pipeline_utils.StableDiffusionMixin.enable_vae_tiling
    ...
    # Copied from custom_diffusers.pipelines.pipeline_utils.StableDiffusionMixin.disable_vae_tiling
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.encode_prompt with self.tokenizer->self.clip_tokenizer
    def encode_prompt(
        self,
        prompt,
        device,
    ...
    # Modified from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion_instruct_pix2pix.StableDiffusionInstructPix2PixPipeline.prepare_image_latents
