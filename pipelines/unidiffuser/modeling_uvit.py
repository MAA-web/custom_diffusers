...
# Modified from custom_diffusers.models.attention.BasicTransformerBlock
...
class UniDiffuserBlock(nn.Module):
    ...
    def forward(
        ...
        # Following the custom_diffusers transformer block implementation, put the LayerNorm on the
        # residual backbone
        # Pre-LayerNorm
        if self.pre_layer_norm:
            if self.use_ada_layer_norm:
...
# Modified from custom_diffusers.models.transformer_2d.Transformer2DModel
