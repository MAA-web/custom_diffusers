...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from custom_diffusers.pipelines.ltx.pipeline_ltx_condition import LTXConditionPipeline, LTXVideoCondition
        >>> from custom_diffusers.utils import export_to_video, load_video, load_image
        ...
        >>> video = load_video(
        ...     "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/custom_diffusers/cosmos/cosmos-video2world-input-vid.mp4"
        ... )
        >>> image = load_image(
        ...     "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/custom_diffusers/cosmos/cosmos-video2world-input.jpg"
        ... )
...
class LTXConditionPipeline(DiffusionPipeline, FromSingleFileMixin, LTXVideoLoraLoaderMixin):
    ...
    # Copied from custom_diffusers.pipelines.mochi.pipeline_mochi.MochiPipeline.encode_prompt
    def encode_prompt(
        self,
    ...
    @staticmethod
    # Copied from custom_diffusers.pipelines.ltx.pipeline_ltx.LTXPipeline._pack_latents
    ...
    @staticmethod
    # Copied from custom_diffusers.pipelines.ltx.pipeline_ltx.LTXPipeline._unpack_latents
    def _unpack_latents(
    ...
    @staticmethod
    # Copied from custom_diffusers.pipelines.ltx.pipeline_ltx.LTXPipeline._normalize_latents
    ...
    @staticmethod
    # Copied from custom_diffusers.pipelines.ltx.pipeline_ltx.LTXPipeline._denormalize_latents
