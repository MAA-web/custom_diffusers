...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from custom_diffusers import StableDiffusionSAGPipeline
...
class StableDiffusionSAGPipeline(
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion_k_diffusion.pipeline_stable_diffusion_k_diffusion.StableDiffusionKDiffusionPipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        height,
    ...
    # Modified from custom_diffusers.schedulers.scheduling_ddim.DDIMScheduler.step
