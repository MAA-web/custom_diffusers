...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from custom_diffusers import KolorsImg2ImgPipeline
        >>> from custom_diffusers.utils import load_image

        >>> pipe = KolorsImg2ImgPipeline.from_pretrained(
        ...     "Kwai-Kolors/Kolors-custom_diffusers", variant="fp16", torch_dtype=torch.float16
        ... )
        >>> pipe = pipe.to("cuda")
        >>> url = (
...
class KolorsImg2ImgPipeline(DiffusionPipeline, StableDiffusionMixin, StableDiffusionXLLoraLoaderMixin, IPAdapterMixin):
    ...
    Args:
        ...
        force_zeros_for_empty_prompt (`bool`, *optional*, defaults to `"False"`):
            ...
            `Kwai-Kolors/Kolors-custom_diffusers`.
    """
    ...
    # Copied from custom_diffusers.pipelines.kolors.pipeline_kolors.KolorsPipeline.encode_prompt
    def encode_prompt(
        self,
        prompt,
    ...
    def __call__(
        ...
        Args:
            ...
            height (`int`, *optional*, defaults to self.unet.config.sample_size * self.vae_scale_factor):
                ...
                [Kwai-Kolors/Kolors-custom_diffusers](https://huggingface.co/Kwai-Kolors/Kolors-custom_diffusers) and checkpoints
            ...
            denoising_start (`float`, *optional*):
                ...
                Quality**](https://huggingface.co/docs/custom_diffusers/using-custom_diffusers/sdxl#refine-image-quality).
