...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from custom_diffusers import LattePipeline
...
class LattePipeline(DiffusionPipeline):
    ...
    # Adapted from custom_diffusers.pipelines.deepfloyd_if.pipeline_if.encode_prompt
    def encode_prompt(
        self,
    ...
    # Similar to custom_diffusers.pipelines.stable_video_diffusion.pipeline_stable_video_diffusion.decode_latents
