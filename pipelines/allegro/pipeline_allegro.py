...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from custom_diffusers import AutoencoderKLAllegro, AllegroPipeline
...
class AllegroPipeline(DiffusionPipeline):
    ...
    # Copied from custom_diffusers.pipelines.pixart_alpha.pipeline_pixart_alpha.PixArtAlphaPipeline.encode_prompt with 120->512, num_images_per_prompt->num_videos_per_prompt
    def encode_prompt(
        self,
