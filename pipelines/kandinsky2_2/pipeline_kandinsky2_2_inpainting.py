...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from custom_diffusers import KandinskyV22InpaintPipeline, KandinskyV22PriorPipeline
...
# Copied from custom_diffusers.pipelines.kandinsky2_2.pipeline_kandinsky2_2.downscale_height_and_width
...
# Copied from custom_diffusers.pipelines.kandinsky.pipeline_kandinsky_inpaint.prepare_mask
...
# Copied from custom_diffusers.pipelines.kandinsky.pipeline_kandinsky_inpaint.prepare_mask_and_masked_image
        ...
        **kwargs,
        ...
        if not self._warn_has_been_called and version.parse(version.parse(__version__).base_version) < version.parse(
            ...
            logger.warning(
                ...
                "Before custom_diffusers == 0.19.0, Kandinsky Inpainting pipelines repainted black pixels and preserved black pixels. "
                "As of custom_diffusers==0.19.0 this behavior has been inverted. Now white pixels are repainted and black pixels are preserved. "
                "This way, Kandinsky's masking behavior is aligned with Stable Diffusion. "
                "THIS means that you HAVE to invert the input mask to have the same behavior as before as explained in https://github.com/huggingface/custom_diffusers/pull/4207. "
                "This warning will be suppressed after the first inference call and will be removed in custom_diffusers>0.23.0"
            )
