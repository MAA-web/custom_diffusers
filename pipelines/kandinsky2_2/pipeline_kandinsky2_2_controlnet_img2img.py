...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from custom_diffusers import KandinskyV22PriorEmb2EmbPipeline, KandinskyV22ControlnetImg2ImgPipeline
...
class KandinskyV22ControlnetImg2ImgPipeline(DiffusionPipeline):
    ...
    # Copied from custom_diffusers.pipelines.kandinsky.pipeline_kandinsky_img2img.KandinskyImg2ImgPipeline.get_timesteps
    ...
    # Copied from custom_diffusers.pipelines.kandinsky2_2.pipeline_kandinsky2_2_img2img.KandinskyV22Img2ImgPipeline.prepare_latents
