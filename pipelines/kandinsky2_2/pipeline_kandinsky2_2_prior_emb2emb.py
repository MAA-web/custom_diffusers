...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from custom_diffusers import KandinskyV22Pipeline, KandinskyV22PriorEmb2EmbPipeline
        >>> import torch
...
EXAMPLE_INTERPOLATE_DOC_STRING = """
    Examples:
        ```py
        >>> from custom_diffusers import KandinskyV22PriorEmb2EmbPipeline, KandinskyV22Pipeline
