...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from custom_diffusers import KandinskyV22Pipeline, KandinskyV22PriorPipeline
        >>> import torch
...
EXAMPLE_INTERPOLATE_DOC_STRING = """
    Examples:
        ```py
        >>> from custom_diffusers import KandinskyV22PriorPipeline, KandinskyV22Pipeline
...
class KandinskyV22PriorPipeline(DiffusionPipeline):
    ...
    # Copied from custom_diffusers.pipelines.kandinsky.pipeline_kandinsky_prior.KandinskyPriorPipeline.get_zero_embed
    ...
    # Copied from custom_diffusers.pipelines.kandinsky.pipeline_kandinsky_prior.KandinskyPriorPipeline._encode_prompt
    def _encode_prompt(
        self,
        prompt,
        device,
