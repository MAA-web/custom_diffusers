...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> import torch
        >>> import PIL.Image
        >>> from custom_diffusers import AutoencoderKLWan, WanVACEPipeline
        >>> from custom_diffusers.schedulers.scheduling_unipc_multistep import UniPCMultistepScheduler
        ...
        >>> # Available checkpoints: Wan-AI/Wan2.1-VACE-1.3B-custom_diffusers, Wan-AI/Wan2.1-VACE-14B-custom_diffusers
        >>> model_id = "Wan-AI/Wan2.1-VACE-1.3B-custom_diffusers"
...
class WanVACEPipeline(DiffusionPipeline, WanLoraLoaderMixin):
    ...
    # Copied from custom_diffusers.pipelines.wan.pipeline_wan.WanPipeline._get_t5_prompt_embeds
    ...
    # Copied from custom_diffusers.pipelines.wan.pipeline_wan.WanPipeline.encode_prompt
    def encode_prompt(
        self,
    ...
    def __call__(
        ...
        Args:
            ...
            reference_images (`List[PIL.Image.Image]`, *optional*):
                ...
                character here. Refer to the Diffusers [examples](https://github.com/huggingface/custom_diffusers/pull/11582)
                and original [user
