...
EXAMPLE_DOC_STRING = """
    Examples:
        ```python
        >>> import torch
        >>> from custom_diffusers import Cosmos2TextToImagePipeline
...
class Cosmos2TextToImagePipeline(DiffusionPipeline):
    ...
    # Copied from custom_diffusers.pipelines.cosmos.pipeline_cosmos_text2world.CosmosTextToWorldPipeline.encode_prompt with num_videos_per_prompt->num_images_per_prompt
    def encode_prompt(
        self,
