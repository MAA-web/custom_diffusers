...
EXAMPLE_DOC_STRING = """
    Examples:
        ```python
        >>> import torch
        >>> from custom_diffusers import Cosmos2VideoToWorldPipeline
        ...
        >>> image = load_image(
        ...     "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/custom_diffusers/yellow-scrubber.png"
        ... )
...
class Cosmos2VideoToWorldPipeline(DiffusionPipeline):
    ...
    # Copied from custom_diffusers.pipelines.cosmos.pipeline_cosmos_text2world.CosmosTextToWorldPipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        height,
