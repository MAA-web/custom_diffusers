...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        ```python
        >>> import torch
        >>> from custom_diffusers import CosmosVideoToWorldPipeline
...
class CosmosVideoToWorldPipeline(DiffusionPipeline):
    ...
    # Copied from custom_diffusers.pipelines.cosmos.pipeline_cosmos_text2world.CosmosTextToWorldPipeline._get_t5_prompt_embeds
    ...
    # Copied from custom_diffusers.pipelines.cosmos.pipeline_cosmos_text2world.CosmosTextToWorldPipeline.encode_prompt
    def encode_prompt(
        self,
