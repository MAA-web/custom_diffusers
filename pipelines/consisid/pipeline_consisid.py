...
EXAMPLE_DOC_STRING = """
    Examples:
        ```python
        >>> import torch
        >>> from custom_diffusers import ConsisIDPipeline
        >>> from custom_diffusers.pipelines.consisid.consisid_utils import prepare_face_models, process_face_embeddings_infer
        >>> from custom_diffusers.utils import export_to_video
        ...
        >>> image = "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/custom_diffusers/consisid/consisid_input.png?download=true"
