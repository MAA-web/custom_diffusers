...
EXAMPLE_DOC_STRING = """
    Examples:
        ```python
        >>> import torch
        >>> from custom_diffusers import CogVideoXFunControlPipeline, DDIMScheduler
...
# Copied from custom_diffusers.pipelines.cogvideo.pipeline_cogvideox.get_resize_crop_region_for_grid
...
class CogVideoXFunControlPipeline(DiffusionPipeline, CogVideoXLoraLoaderMixin):
    ...
    # Copied from custom_diffusers.pipelines.cogvideo.pipeline_cogvideox.CogVideoXPipeline.prepare_latents
    def prepare_latents(
