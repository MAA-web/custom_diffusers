...
class PaintByExamplePipeline(DeprecatedPipelineMixin, DiffusionPipeline, StableDiffusionMixin):
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion_image_variation.StableDiffusionImageVariationPipeline.check_inputs
    ...
    def __call__(
        ...
        >>> from custom_diffusers import PaintByExamplePipeline
