...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> import requests
        >>> import torch
        >>> from custom_diffusers import AnimateDiffVideoToVideoPipeline, DDIMScheduler, MotionAdapter
        ...
        >>> video = load_video(
        ...     "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/custom_diffusers/animatediff-vid2vid-input-1.gif"
        ... )
        >>> output = pipe(
