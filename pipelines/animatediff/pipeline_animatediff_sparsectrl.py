...
EXAMPLE_DOC_STRING = """
    Examples:
        ```python
        >>> import torch
        >>> from custom_diffusers import AnimateDiffSparseControlNetPipeline
        >>> from custom_diffusers.models import AutoencoderKL, MotionAdapter, SparseControlNetModel
        >>> from custom_diffusers.schedulers import DPMSolverMultistepScheduler
        >>> from custom_diffusers.utils import export_to_gif, load_image
        ...
        >>> image_files = [
        ...     "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/custom_diffusers/animatediff-scribble-1.png",
        ...     "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/custom_diffusers/animatediff-scribble-2.png",
        ...     "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/custom_diffusers/animatediff-scribble-3.png",
        ... ]
...
class AnimateDiffSparseControlNetPipeline(
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.encode_prompt with num_images_per_prompt -> num_videos_per_prompt
    def encode_prompt(
        self,
        prompt,
        device,
    ...
    # Copied from custom_diffusers.pipelines.text_to_video_synthesis/pipeline_text_to_video_synth.TextToVideoSDPipeline.decode_latents
    ...
    # Copied from custom_diffusers.pipelines.text_to_video_synthesis.pipeline_text_to_video_synth.TextToVideoSDPipeline.prepare_latents
    def prepare_latents(
