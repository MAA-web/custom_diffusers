...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from custom_diffusers import AnimateDiffVideoToVideoControlNetPipeline
        >>> from custom_diffusers.utils import export_to_gif, load_video
        >>> from custom_diffusers import AutoencoderKL, ControlNetModel, MotionAdapter, LCMScheduler
        ...
        >>> video = load_video(
        ...     "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/custom_diffusers/dance.gif"
        ... )
...
class AnimateDiffVideoToVideoControlNetPipeline(
    ...
    # Copied from custom_diffusers.pipelines.animatediff.pipeline_animatediff_video2video.AnimateDiffVideoToVideoPipeline.encode_prompt
    def encode_prompt(
        self,
        prompt,
        device,
    ...
    # Copied from custom_diffusers.pipelines.animatediff.pipeline_animatediff_video2video.AnimateDiffVideoToVideoPipeline.encode_video
    ...
    # Copied from custom_diffusers.pipelines.animatediff.pipeline_animatediff.AnimateDiffPipeline.decode_latents
    ...
    # Copied from custom_diffusers.pipelines.animatediff.pipeline_animatediff_video2video.AnimateDiffVideoToVideoPipeline.get_timesteps
    ...
    # Copied from custom_diffusers.pipelines.animatediff.pipeline_animatediff_video2video.AnimateDiffVideoToVideoPipeline.prepare_latents
    def prepare_latents(
        self,
    ...
    # Copied from custom_diffusers.pipelines.animatediff.pipeline_animatediff_controlnet.AnimateDiffControlNetPipeline.prepare_video
