...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from custom_diffusers import MusicLDMPipeline
        >>> import torch
        >>> import scipy
...
class MusicLDMPipeline(DeprecatedPipelineMixin, DiffusionPipeline, StableDiffusionMixin):
    ...
    # Copied from custom_diffusers.pipelines.audioldm2.pipeline_audioldm2.AudioLDM2Pipeline.score_waveforms
    ...
    # Copied from custom_diffusers.pipelines.audioldm.pipeline_audioldm.AudioLDMPipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        audio_length_in_s,
    ...
    # Copied from custom_diffusers.pipelines.audioldm.pipeline_audioldm.AudioLDMPipeline.prepare_latents
