...
EXAMPLE_DOC_STRING = """
    Examples:
        ```python
        >>> import torch
        >>> from custom_diffusers import CogView4ControlPipeline
...
# Copied from custom_diffusers.pipelines.cogview4.pipeline_cogview4.calculate_shift
def calculate_shift(
    image_seq_len,
...
# Copied from custom_diffusers.pipelines.cogview4.pipeline_cogview4.retrieve_timesteps
...
class CogView4ControlPipeline(DiffusionPipeline):
    ...
    # Copied from custom_diffusers.pipelines.cogview4.pipeline_cogview4.CogView4Pipeline._get_glm_embeds
    def _get_glm_embeds(
        self,
    ...
    # Copied from custom_diffusers.pipelines.cogview4.pipeline_cogview4.CogView4Pipeline.encode_prompt
    def encode_prompt(
        self,
