...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from custom_diffusers import StableDiffusionXLInstructPix2PixPipeline
        >>> from custom_diffusers.utils import load_image

        >>> resolution = 768
        >>> image = load_image(
        ...     "https://hf.co/datasets/custom_diffusers/custom_diffusers-images-docs/resolve/main/mountain.png"
        ... ).resize((resolution, resolution))
        >>> edit_instruction = "Turn sky into a cloudy one"

        >>> pipe = StableDiffusionXLInstructPix2PixPipeline.from_pretrained(
        ...     "custom_diffusers/sdxl-instructpix2pix-768", torch_dtype=torch.float16
        ... ).to("cuda")
