...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from custom_diffusers import EulerDiscreteScheduler, MotionAdapter, PIAPipeline
        ...
        >>> image = load_image(
        ...     "https://huggingface.co/datasets/hf-internal-testing/custom_diffusers-images/resolve/main/pix2pix/cat_6.png?download=true"
        ... )
