...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from custom_diffusers import StableDiffusionPanoramaPipeline, DDIMScheduler
...
class StableDiffusionPanoramaPipeline(
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        height,
