...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from custom_diffusers import StableUnCLIPImg2ImgPipeline
...
class StableUnCLIPImg2ImgPipeline(
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_unclip.StableUnCLIPPipeline.noise_image_embeddings
