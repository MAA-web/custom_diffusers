...
class StableDiffusionUpscalePipeline(
    ...
    def __call__(
        ...
        >>> from custom_diffusers import StableDiffusionUpscalePipeline
        >>> import torch
        ...
        >>> url = "https://huggingface.co/datasets/hf-internal-testing/custom_diffusers-images/resolve/main/sd2-upscale/low_res_cat.png"
