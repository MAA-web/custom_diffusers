...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from custom_diffusers import StableUnCLIPPipeline
...
class StableUnCLIPPipeline(
    ...
    # Copied from custom_diffusers.pipelines.unclip.pipeline_unclip.UnCLIPPipeline._encode_prompt with _encode_prompt->_encode_prior_prompt, tokenizer->prior_tokenizer, text_encoder->prior_text_encoder
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.prepare_extra_step_kwargs with prepare_extra_step_kwargs->prepare_prior_extra_step_kwargs, scheduler->prior_scheduler
    ...
    # Copied from custom_diffusers.pipelines.unclip.pipeline_unclip.UnCLIPPipeline.prepare_latents
