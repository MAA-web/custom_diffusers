...
# Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion_upscale.preprocess
...
class StableDiffusionLatentUpscalePipeline(DiffusionPipeline, StableDiffusionMixin, FromSingleFileMixin):
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion_upscale.StableDiffusionUpscalePipeline.prepare_latents
    ...
    def __call__(
        ...
        Examples:
        ```py
        >>> from custom_diffusers import StableDiffusionLatentUpscalePipeline, StableDiffusionPipeline
        >>> import torch
