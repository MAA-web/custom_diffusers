...
# Copied from custom_diffusers.pipelines.deepfloyd_if.pipeline_if_img2img.resize
...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from custom_diffusers import IFInpaintingPipeline, IFInpaintingSuperResolutionPipeline, DiffusionPipeline
        >>> from custom_diffusers.utils import pt_to_pil
        >>> import torch
        >>> from PIL import Image
        >>> import requests
        >>> from io import BytesIO

        >>> url = "https://huggingface.co/datasets/custom_diffusers/docs-images/resolve/main/if/person.png"
        >>> response = requests.get(url)
        >>> original_image = Image.open(BytesIO(response.content)).convert("RGB")
        >>> original_image = original_image

        >>> url = "https://huggingface.co/datasets/custom_diffusers/docs-images/resolve/main/if/glasses_mask.png"
        >>> response = requests.get(url)
...
class IFInpaintingSuperResolutionPipeline(DiffusionPipeline, StableDiffusionLoraLoaderMixin):
    ...
    # Copied from custom_diffusers.pipelines.deepfloyd_if.pipeline_if.IFPipeline._text_preprocessing
    ...
    # Copied from custom_diffusers.pipelines.deepfloyd_if.pipeline_if.IFPipeline._clean_caption
    ...
    @torch.no_grad()
    # Copied from custom_diffusers.pipelines.deepfloyd_if.pipeline_if.IFPipeline.encode_prompt
    def encode_prompt(
        self,
    ...
    # Copied from custom_diffusers.pipelines.deepfloyd_if.pipeline_if.IFPipeline.run_safety_checker
    ...
    # Copied from custom_diffusers.pipelines.deepfloyd_if.pipeline_if.IFPipeline.prepare_extra_step_kwargs
    ...
    # Copied from custom_diffusers.pipelines.deepfloyd_if.pipeline_if_img2img.IFImg2ImgPipeline.preprocess_image with preprocess_image -> preprocess_original_image
    ...
    # Copied from custom_diffusers.pipelines.deepfloyd_if.pipeline_if_superresolution.IFSuperResolutionPipeline.preprocess_image
    ...
    # Copied from custom_diffusers.pipelines.deepfloyd_if.pipeline_if_inpainting.IFInpaintingPipeline.preprocess_mask_image
    ...
    # Copied from custom_diffusers.pipelines.deepfloyd_if.pipeline_if_inpainting.IFInpaintingPipeline.prepare_intermediate_images
