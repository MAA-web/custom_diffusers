...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from custom_diffusers import IFPipeline, IFSuperResolutionPipeline, DiffusionPipeline
...
class IFSuperResolutionPipeline(DiffusionPipeline, StableDiffusionLoraLoaderMixin):
    ...
    # Copied from custom_diffusers.pipelines.deepfloyd_if.pipeline_if.IFPipeline.prepare_intermediate_images
