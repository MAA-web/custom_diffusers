...
class PixArtSigmaPAGPipeline(DiffusionPipeline, PAGMixin):
    ...
    # Copied from custom_diffusers.pipelines.pixart_alpha.pipeline_pixart_alpha.PixArtAlphaPipeline.encode_prompt with 120->300
    def encode_prompt(
        self,
    ...
    # Copied from custom_diffusers.pipelines.pixart_alpha.pipeline_pixart_alpha.PixArtAlphaPipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        height,
