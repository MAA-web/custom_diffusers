...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from custom_diffusers import SanaPAGPipeline
...
class SanaPAGPipeline(DiffusionPipeline, PAGMixin):
    ...
    (PAG)](https://huggingface.co/docs/custom_diffusers/main/en/using-custom_diffusers/pag).
    """
    ...
    # Copied from custom_diffusers.pipelines.sana.pipeline_sana.SanaPipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        height,
    ...
    # Copied from custom_diffusers.pipelines.sana.pipeline_sana.SanaPipeline._text_preprocessing
    ...
    # Copied from custom_diffusers.pipelines.sana.pipeline_sana.SanaPipeline._clean_caption
    ...
    # Copied from custom_diffusers.pipelines.sana.pipeline_sana.SanaPipeline.prepare_latents
