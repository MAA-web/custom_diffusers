...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> import cv2
        >>> from custom_diffusers import AutoPipelineForInpainting, ControlNetModel, DDIMScheduler
        >>> from custom_diffusers.utils import load_image
        >>> import numpy as np
        >>> from PIL import Image
        >>> import torch

        >>> init_image = load_image(
        ...     "https://huggingface.co/datasets/custom_diffusers/test-arrays/resolve/main/stable_diffusion_inpaint/boy.png"
        ... )
        ...
        ...     "https://huggingface.co/datasets/custom_diffusers/test-arrays/resolve/main/stable_diffusion_inpaint/boy_mask.png"
        ... )
...
# Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion_img2img.retrieve_latents
...
class StableDiffusionControlNetPAGInpaintPipeline(
    ...
    def __init__(
        ...
        if safety_checker is None and requires_safety_checker:
            logger.warning(
                ...
                " results in services or applications open to the public. Both the custom_diffusers team and Hugging Face"
                " strongly recommend to keep the safety filter enabled in all public facing circumstances, disabling"
                " it only for use-cases that involve analyzing network behavior or auditing its results. For more"
                " information, please have a look at https://github.com/huggingface/custom_diffusers/pull/254 ."
            )
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.encode_prompt
    def encode_prompt(
        self,
        prompt,
        device,
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.encode_image
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.prepare_ip_adapter_image_embeds
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.run_safety_checker
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.prepare_extra_step_kwargs
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion_img2img.StableDiffusionImg2ImgPipeline.get_timesteps
    ...
    # Copied from custom_diffusers.pipelines.controlnet.pipeline_controlnet.StableDiffusionControlNetPipeline.check_image
    ...
    # Copied from custom_diffusers.pipelines.controlnet.pipeline_controlnet_inpaint.StableDiffusionControlNetInpaintPipeline.prepare_control_image
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion_inpaint.StableDiffusionInpaintPipeline.prepare_latents
    def prepare_latents(
        self,
        batch_size,
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion_inpaint.StableDiffusionInpaintPipeline.prepare_mask_latents
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion_inpaint.StableDiffusionInpaintPipeline._encode_vae_image
    ...
    # Copied from custom_diffusers.pipelines.latent_consistency_models.pipeline_latent_consistency_text2img.LatentConsistencyModelPipeline.get_guidance_scale_embedding
    ...
    def __call__(
        ...
        Args:
            ...
            cross_attention_kwargs (`dict`, *optional*):
                ...
                [`self.processor`](https://github.com/huggingface/custom_diffusers/blob/main/src/custom_diffusers/models/attention_processor.py).
