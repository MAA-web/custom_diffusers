...
# Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion_img2img.preprocess
...
class CycleDiffusionPipeline(DiffusionPipeline, TextualInversionLoaderMixin, StableDiffusionLoraLoaderMixin):
    ...
    def __call__(
        ...
        from custom_diffusers import CycleDiffusionPipeline, DDIMScheduler
