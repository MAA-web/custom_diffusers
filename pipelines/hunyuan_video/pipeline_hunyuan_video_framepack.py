...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        ```python
        >>> import torch
        >>> from custom_diffusers import HunyuanVideoFramepackPipeline, HunyuanVideoFramepackTransformer3DModel
        ...
        ...     "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/custom_diffusers/flf2v_input_first_frame.png"
        ... )
        >>> last_image = load_image(
        ...     "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/custom_diffusers/flf2v_input_last_frame.png"
        ... )
        >>> output = pipe(
        ...     image=first_image,
...
class HunyuanVideoFramepackPipeline(DiffusionPipeline, HunyuanVideoLoraLoaderMixin):
    ...
    # Copied from custom_diffusers.pipelines.hunyuan_video.pipeline_hunyuan_video.HunyuanVideoPipeline._get_llama_prompt_embeds
    ...
    # Copied from custom_diffusers.pipelines.hunyuan_video.pipeline_hunyuan_video.HunyuanVideoPipeline._get_clip_prompt_embeds
    ...
    # Copied from custom_diffusers.pipelines.hunyuan_video.pipeline_hunyuan_video.HunyuanVideoPipeline.encode_prompt
    def encode_prompt(
        self,
        prompt: Union[str, List[str]],
