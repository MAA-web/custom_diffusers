...
EXAMPLE_DOC_STRING = """
    Examples:
        ```python
        >>> import torch
        >>> from custom_diffusers import HunyuanVideoImageToVideoPipeline, HunyuanVideoTransformer3DModel
        ...
        >>> image = load_image(
        ...     "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/custom_diffusers/guitar-man.png"
        ... )
