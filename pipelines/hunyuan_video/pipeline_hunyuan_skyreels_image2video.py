...
EXAMPLE_DOC_STRING = """
    Examples:
        ```python
        >>> import torch
        >>> from custom_diffusers import HunyuanSkyreelsImageToVideoPipeline, HunyuanVideoTransformer3DModel
        >>> from custom_diffusers.utils import load_image, export_to_video
...
class HunyuanSkyreelsImageToVideoPipeline(DiffusionPipeline, HunyuanVideoLoraLoaderMixin):
    ...
    # Copied from custom_diffusers.pipelines.hunyuan_video.pipeline_hunyuan_video.HunyuanVideoPipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        prompt_2,
