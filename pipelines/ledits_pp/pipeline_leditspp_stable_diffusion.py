...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from custom_diffusers import LEditsPPPipelineStableDiffusion
...
# Modified from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionAttendAndExcitePipeline.AttentionStore
...
# Modified from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionAttendAndExcitePipeline.GaussianSmoothing
...
class LEditsPPPipelineStableDiffusion(
    ...
    # Modified from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.check_inputs
    def check_inputs(
        self,
