...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from custom_diffusers import StableVideoDiffusionPipeline
        ...
        >>> image = load_image(
        ...     "https://huggingface.co/datasets/huggingface/documentation-images/resolve/main/custom_diffusers/svd-docstring-example.jpeg"
        ... )
