...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> import scipy
        >>> import torch
        >>> from custom_diffusers import AudioLDM2Pipeline
...
class AudioLDM2Pipeline(DiffusionPipeline):
    ...
    # Copied from custom_diffusers.pipelines.audioldm.pipeline_audioldm.AudioLDMPipeline.mel_spectrogram_to_waveform
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion.pipeline_stable_diffusion.StableDiffusionPipeline.prepare_latents with width->self.vocoder.config.model_in_dim
