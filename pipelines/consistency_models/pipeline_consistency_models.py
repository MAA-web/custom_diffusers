...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from custom_diffusers import ConsistencyModelPipeline

        >>> device = "cuda"
        >>> # Load the cd_imagenet64_l2 checkpoint.
        >>> model_id_or_path = "openai/custom_diffusers-cd_imagenet64_l2"
...
class ConsistencyModelPipeline(DiffusionPipeline):
    ...
    # Follows custom_diffusers.VaeImageProcessor.postprocess
    def postprocess_image(self, sample: torch.Tensor, output_type: str = "pil"):
        ...
        # Equivalent to custom_diffusers.VaeImageProcessor.denormalize
        sample = (sample / 2 + 0.5).clamp(0, 1)
        if output_type == "pt":
            return sample

        # Equivalent to custom_diffusers.VaeImageProcessor.pt_to_numpy
