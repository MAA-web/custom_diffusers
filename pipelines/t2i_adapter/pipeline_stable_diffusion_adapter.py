...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> import torch
        >>> from custom_diffusers import StableDiffusionAdapterPipeline, T2IAdapter

        >>> image = load_image(
        ...     "https://huggingface.co/datasets/custom_diffusers/docs-images/resolve/main/t2i-adapter/color_ref.png"
        ... )
