...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from custom_diffusers import StableDiffusion3ControlNetPipeline
        >>> from custom_diffusers.models import SD3ControlNetModel, SD3MultiControlNetModel
        >>> from custom_diffusers.utils import load_image

        >>> controlnet = SD3ControlNetModel.from_pretrained("InstantX/SD3-Controlnet-Canny", torch_dtype=torch.float16)

        >>> pipe = StableDiffusion3ControlNetPipeline.from_pretrained(
        ...     "stabilityai/stable-diffusion-3-medium-custom_diffusers", controlnet=controlnet, torch_dtype=torch.float16
        ... )
        >>> pipe.to("cuda")
        >>> control_image = load_image(
        ...     "https://huggingface.co/datasets/hf-internal-testing/custom_diffusers-images/resolve/main/sd_controlnet/bird_canny.png"
        ... )
...
class StableDiffusion3ControlNetPipeline(
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion_3.pipeline_stable_diffusion_3.StableDiffusion3Pipeline.prepare_latents
    def prepare_latents(
        self,
        batch_size,
