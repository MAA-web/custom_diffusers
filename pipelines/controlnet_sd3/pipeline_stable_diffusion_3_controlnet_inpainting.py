...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> import torch
        >>> from custom_diffusers.utils import load_image, check_min_version
        >>> from custom_diffusers.pipelines import StableDiffusion3ControlNetInpaintingPipeline
        >>> from custom_diffusers.models.controlnet_sd3 import SD3ControlNetModel

        >>> controlnet = SD3ControlNetModel.from_pretrained(
        ...     "alimama-creative/SD3-Controlnet-Inpainting", use_safetensors=True, extra_conditioning_channels=1
        ... )
        >>> pipe = StableDiffusion3ControlNetInpaintingPipeline.from_pretrained(
        ...     "stabilityai/stable-diffusion-3-medium-custom_diffusers",
...
class StableDiffusion3ControlNetInpaintingPipeline(
    ...
    # Copied from custom_diffusers.pipelines.stable_diffusion_3.pipeline_stable_diffusion_3.StableDiffusion3Pipeline.check_inputs
    def check_inputs(
        self,
        prompt,
        prompt_2,
