...
EXAMPLE_DOC_STRING = """
    Examples:
        ```py
        >>> from custom_diffusers.pipelines import BlipDiffusionControlNetPipeline
...
class BlipDiffusionControlNetPipeline(DiffusionPipeline):
    ...
    # Copied from custom_diffusers.pipelines.consistency_models.pipeline_consistency_models.ConsistencyModelPipeline.prepare_latents
    ...
    # Adapted from custom_diffusers.pipelines.controlnet.pipeline_controlnet.StableDiffusionControlNetPipeline.prepare_image
