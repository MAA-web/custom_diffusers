...
EXAMPLE_DOC_STRING = """
    Examples:
        ...
        >>> from custom_diffusers import StableDiffusionXLControlNetUnionPipeline, ControlNetUnionModel, AutoencoderKL
        ...
        >>> # download an image
        >>> image = load_image(
        ...     "https://huggingface.co/datasets/hf-internal-testing/custom_diffusers-images/resolve/main/kandinsky/cat.png"
        ... ).resize((1024, 1024))
